...
const Testimonials = ({ data }: iProps) => {
    ...
    return (
        ...
        <View style={{ flexDirection: 'row',backgroundColor:'white',borderBottomWidth:1 ,borderBottomColor:'gray'}}>
            <View style={{ width: 4, backgroundColor: theme.colors.primary, left: 0, marginRight: 8 }} />
            <View style={{ flexDirection: 'row', alignItems: 'center',padding:8 }}>
                <Avatar.Image source={{ uri:'https://static.vecteezy.com/system/resources/previews/000/642/975/original/quote-sign-icon-quotation-mark-vector.jpg' }} />
